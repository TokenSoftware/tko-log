package com.token01.streaming.project.dao

import com.token01.streaming.project.entity.CourseSearchClickCount
import com.token01.streaming.project.util.HBaseUtilOld
