package com.token01.streaming.project

import com.token01.streaming.project.dao.{CourseClickCountDAO, CourseSearchClickCountDAO}
import com.token01.streaming.project.entity.{ClickLog, CourseClickCount, CourseSearchClickCount}
import com.token01.streaming.project.util.DateUtil
