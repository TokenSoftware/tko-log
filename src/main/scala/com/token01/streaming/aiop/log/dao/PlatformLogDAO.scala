package com.token01.streaming.aiop.log.dao

import com.token01.streaming.aiop.log.entity.{HBaseData, PlatformLog}
import com.token01.streaming.aiop.log.util.HBaseUtil
